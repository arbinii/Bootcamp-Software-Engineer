import 'package:MyFinance/presentation/widgets/circular_chart.dart';

// import 'package:MyFinance/presentation/widgets/spline_chart.dart';
...
class _StatisticsState extends State<Statistics>
  ...
  void sortTransactionsByDateDescending() {
    currListTransaction.sort((a, b) => b.createAt.compareTo(a.createAt));
  }
  ...
  void fetchTransactions() {
    ...
    // Tambah panggilan fungsi untuk mengurutkan transaksi
            ...
            return ListTile(
              ...
              trailing: Text(
                ...
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 17,
                  color: currListTransaction[index].type == 'Pengeluaran'
                      ? Colors.red
                      : Colors.green,
                ),
              ),

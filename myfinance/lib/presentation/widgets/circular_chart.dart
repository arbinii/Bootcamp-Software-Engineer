...
class _CircularChartState extends State<CircularChart> {
  ...
  Widget build(BuildContext context) {
    if (widget.title == 'Pemasukan' && incomeData.isEmpty) {
      return SizedBox(
    ...
    } else if (widget.title == 'Pengeluaran' && expenseData.isEmpty) {
      return Padding(
    ...
    return SizedBox(
        ...
        child: SfCircularChart(
            palette: widget.title == 'Pemasukan'
                ? const <Color>[
            ...
            series: <CircularSeries>[
              ...
              DoughnutSeries<ChartData, String>(
                  dataSource:
                      widget.title == 'Pemasukan' ? incomeData : expenseData,

      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                // Navigasi kembali ke halaman "My Skin"
                Navigator.of(context).pop();
              },
              child: Text('Back'),
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(Color.fromARGB(243, 202, 146, 236))
              ),
            ),
          ],
        ),
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    SizedBox(
                      ...
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(const Color.fromARGB(243, 202, 146, 236)),
                      ),
                      onPressed: () {
                        if (galleryFile != null) {
